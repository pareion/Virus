...
{
    public class NeuralNetworkComputer : IVirusPlayer
    {
        ...
        public NeuralNetworkComputer(Board board, int playerNumber, ActivationFunction activation, bool storage, int depth)
        {
            ...
            hiddenN = board.boardSize * board.boardSize * 4;
        ...
        public void play()
        {
            ...
            catch (Exception)
            {
                ...
                Retrain(input, output, 0.1, 1);
            }
        }

        private void Retrain(double[][] input, double[][] output, double learningrate, int iterations)
        {
